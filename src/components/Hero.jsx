  ...
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
        ...
        <div data-aos="fade-right"
            ...
            <p className='text-base smtext-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]'>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos eos, excepturi velit voluptatibus aperiam numquam! Nam voluptate molestiae assumenda officia ipsam quo cupiditate saepe voluptas similique. Nobis eaque architecto beatae.
            </p>
            ...
            <div className='flex gap-4 mt-12'>
                ...
                <a className='border border-[#2a2a2a] py-2 sm:py-3 px-8 sm:px-10 rounded-full sm:text-lg text-sm font-semibold tracking wider transition-all duration-300 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white' href="#">
                    Get started <i class='bx bxs-send' ></i>
                </a>
            </div>
        ...
        <Spline data-aos="fade-zoom-in"
            ...
            className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-2%] h-full' scene="https://prod.spline.design/L-VuEeTaLqv0jbGI/scene.splinecode" />
